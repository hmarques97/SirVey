...
class Ui_MainWindow(object):
    ...
    def new_load_tile(self):
        global tile, tile_array  # get tile data variables
        options = QFileDialog.Options()
        options |= QFileDialog.DontUseNativeDialog
        tilepath, check = QFileDialog.getOpenFileName(None, "Select Tile", "", "Image Files (*.png *.jpg *.bmp)", options=options)
        if check:
            print("Current image:", str(tilepath))
    ...
    def load_network_model(self):
        ...
        options = QFileDialog.Options()
        options |= QFileDialog.DontUseNativeDialog
        model_path, check = QFileDialog.getOpenFileName(None, "Select Tile", "", "Image Files (*.png *.jpg *.bmp)", options=options)
